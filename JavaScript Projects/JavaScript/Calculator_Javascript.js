...
const Calculator = {
    ...
    First_Operand: null,
    //this checks weather or not the second operand has been inputted by user
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //we ar saying that if the Display_Value does not contain a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //operator is exucuted
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        //added a fixed amount of numbers after the decimal
...
function Update_Display() {
    //make use of calculator-screen class to tart the
...
keys.addEventListener('click', (even) => {
