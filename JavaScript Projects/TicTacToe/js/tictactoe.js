...
let activePlayer ='X';
//this array stores an array of moves. We us this to determin win conditons
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber)))   {
        ...
        if (activePlayer === 'X') {
            ...
            //active player may onl be 'X' or 'O'so, if not 'X' then 'O'
        } else {
        ...
        //this calls a function to check fo any win conditions
        checkWinConditions();
        ...
        //this returning is needed for our computersTurn() function to work
        return true;
    }
    //this function results in a random square being selected by the computer
    function computersTurn() {
        //this boolean is needed fo our while loop
        let success = false;
...
function checkWinConditions() {
    ...
    //This condition chcecks for tie. If non of the above conditions are met and
...
function drawWinLines(coordX1,coordY1,coordX2,coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        //this line indicates where teh end of a lines y axis is
        y2 = coordY2,
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //this variable gets the HTML elements i
